...
Route::group(['middleware' => 'auth'], function () {
	...
	Route::delete('pacientes/deletar/{id}', [PacientesController::class, "destroy"])->name('deletar-paciente');

	Route::get('visitantes', [VisitantController::class, "index"])->name('vistantes');
	Route::post('visitantes', [VisitantController::class, "store"])->name('vistantes/criar');
	Route::delete('visitantes/deletar/{id}', [VisitantController::class, "destroy"])->name('deletar-visitante');
