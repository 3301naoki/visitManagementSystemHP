<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="sidenav-header">
        ...
        <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
            <iconify-icon icon="solar:health-bold" width="38" height="38" style="color: #2180fe"></iconify-icon>
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('pacientes') ? 'active' : '' }}" href="{{ url('pacientes') }}">
                    <div
                        ...
                        <iconify-icon icon="mdi:patient-outline" width="24" height="24"
                            style="color: {{ Request::is('pacientes') ? 'white' : 'black' }}"></iconify-icon>
                    </div>
                    <span class="nav-link-text ms-1">Pacientes</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Request::is('visitantes') ? 'active' : '' }}" href="{{ url('visitantes') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <iconify-icon icon="mdi:person-child" width="24" height="24"
                            style="color: {{ Request::is('visitantes') ? 'white' : 'black' }}"></iconify-icon>
                    </div>
